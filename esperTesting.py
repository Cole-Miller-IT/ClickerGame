...
def run():
    ...
    world.add_component(player, Renderable(image=pygame.image.load("Assets\\redsquare.png"), posx=100, posy=100))
    # Another motionless Entity:
    enemy = world.create_entity()
    world.add_component(enemy, Renderable(image=pygame.image.load("Assets\\bluesquare.png"), posx=400, posy=250))
    ...
    print(enemy)
    print("\n")
    print(world._entities)
    print("\n")
    print(world._components)
